...
public static class SceneSwitcherToolbar
{
    ...
    static void RefreshSceneList()
    {
        ...
        if (fetchAllScenes)
        {
            sceneNames = Directory.GetFiles("Assets/_Project", "*.unity", SearchOption.AllDirectories)
    ...
    static void CheckAndRefreshScenes()
    {
        ...
        string[] currentScenes = fetchAllScenes
            ? Directory.GetFiles("Assets/_Project", "*.unity", SearchOption.AllDirectories)
                .Select(Path.GetFileNameWithoutExtension)
                .ToArray()
    ...
    static void LoadScene(string sceneName)
    {
        ...
        if (fetchAllScenes)
        {
            scenePath = Directory.GetFiles("Assets/_Project", "*.unity", SearchOption.AllDirectories)
